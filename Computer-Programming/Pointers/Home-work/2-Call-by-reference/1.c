...
int main()
{
  ...
  ptr=&m;
  ptr1=&n;
  calculator(ptr,ptr1,&sum,&product,&difference);//Passing the address of each variable so that changes made on the variable are reflected throughout the program
  printf("Sum=%d\n",sum);
  printf("Product=%d\n",product);
  printf("Difference=%d\n",difference);
  return 0;
